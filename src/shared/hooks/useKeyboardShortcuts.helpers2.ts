 ...
 */
export function checkModifiers(event: KeyboardEvent, shortcut: KeyboardShortcut): boolean {
 ...
 */
export function tryExecuteShortcut(event: KeyboardEvent, shortcut: KeyboardShortcut): boolean {
