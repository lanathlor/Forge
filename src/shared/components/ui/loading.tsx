...
export type IndeterminateProgressProps = Omit<
  ProgressBarProps,
  'value' | 'showPercentage'
>;

export const IndeterminateProgress = React.memo(
  React.forwardRef<HTMLDivElement, IndeterminateProgressProps>(
...
export const SkeletonGroup = React.memo(
  React.forwardRef<HTMLDivElement, SkeletonGroupProps>(
    (
      { className, count = 3, spacing = 'default', children, ...props },
      ref
    ) => {
      const spacingClass = {
        sm: 'space-y-2',
      ...
      return (
        ...
        >
          <div className="flex flex-col items-center gap-3">
            <Loader2
              className={cn(
                spinnerVariants({ size: spinnerSize, variant: 'primary' })
              )}
            />
            {label && (
...
export const PulsingDot = React.memo(
  React.forwardRef<HTMLSpanElement, PulsingDotProps>(
    (
      {
        className,
        variant = 'default',
...
export { spinnerVariants, progressBarVariants, progressFillVariants };
