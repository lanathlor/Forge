...
export const StatCardSkeleton = React.memo(
  React.forwardRef<HTMLDivElement, StatCardSkeletonProps>(
...
export const ActionCardSkeleton = React.memo(
  React.forwardRef<HTMLDivElement, ActionCardSkeletonProps>(
...
export const ListCardSkeleton = React.memo(
  React.forwardRef<HTMLDivElement, ListCardSkeletonProps>(
    (
      {
        className,
        variant,
 ...
 */
export const TaskListItemSkeleton = React.memo(
  ({ className }: { className?: string }) => (
    <div
      className={cn(
        'flex items-start gap-3 border-b border-border p-3',
        className
      )}
    >
      <Skeleton variant="circular" className="mt-1 h-5 w-5 shrink-0" />
...
export const TaskListSkeleton = React.memo(
  ({ count = 5, className }: { count?: number; className?: string }) => (
 ...
 */
export const PlanItemSkeleton = React.memo(
  ({ className }: { className?: string }) => (
 ...
 */
export const PlanListSkeleton = React.memo(
 ...
 */
export const RepositorySelectorSkeleton = React.memo(
  ({ className }: { className?: string }) => (
 ...
 */
export const SessionSummarySkeleton = React.memo(
  ({ className }: { className?: string }) => (
        ...
        <div className="space-y-2">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex gap-3">
              <Skeleton variant="circular" className="mt-1 h-3 w-3 shrink-0" />
              <div className="flex-1 space-y-2">
                <Skeleton className="h-4 w-full" />
                <Skeleton className="h-3 w-2/3" />
              </div>
 ...
 */
export const QAGatesConfigSkeleton = React.memo(
  ({ className }: { className?: string }) => (
    <div className={cn('space-y-6 p-6', className)}>
      {/* Header */}
 ...
 */
export const DetailPanelSkeleton = React.memo(
  ({ className }: { className?: string }) => (
